...
export default function ToolGrid({ compact = false, showExternal = true }) {
  ...
  const tools = [
    ...
    },
    {
      ...
      meta: `${stats.settlerCliff || '2k+'} notes · Pro peek`,
      pro: true,
    },
    {
      to: BRAND.pet.route,
      ...
      meta: `${stats.petPhrases || '2k+'} phrases · Pro peek`,
      pro: true,
    },
    {
      ...
      meta: `${stats.coachEntries || '2k+'} insights · Pro peek`,
      pro: true,
    },
    {
    ...
    },
    {
      ...
      emoji: '🎁',
      tagline: 'Sparks, peeks, zero friction fun',
      meta: 'Start here',
    },
    {
      to: '/guides',
