...
export const SEO_HUBS = [
  {
    ...
    "h1": "Sanctum Sphere",
    "emoji": "⑧",
    "summary": "A playful yes/no/maybe oracle with Hazel Allure personality. Free to use. Not real advice — entertainment for decision fatigue.",
  ...
  },
  {
    ...
    "emoji": "🪙",
    "summary": "One face is a heaven-scape YES; the other is a hell-scape NO. Free viral coin flip with sanctum drama.",
  ...
  },
  {
    ...
    "h1": "Hearth Court",
    "emoji": "⚖",
    "summary": "Enter 2–4 sides of a spat. Offline scoring awards a playful winner (or shared moon) with cliff notes. Pro library; free sneak peeks for guests.",
  ...
  },
  {
    ...
    "emoji": "🐾",
    "summary": "Upload a pet clip or just your hope-text. Offline library of 2000+ sanctum translations. Whimsy only — your cat has not been scientifically decoded.",
  ...
  },
  {
    ...
    "h1": "Before the Storm",
    "emoji": "🕯",
    "summary": "Filter by situation and vibe. Draw openers, cliff notes, and “what might have helped” lines from 2000+ scripted insights.",
  ...
  },
  {
    ...
    "emoji": "🔥",
    "summary": "Private journal free forever. Pro can toss anonymous notes into the Hearth. Vent, gossip (kind-ish), drama — held by the sanctum.",
