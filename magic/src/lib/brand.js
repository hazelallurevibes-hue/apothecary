...
export const BRAND = {
  ...
  settler: {
    ...
    short: 'Court',
    emoji: '☽',
    tagline: 'Free: name paths, cast stones, oracle seal. Pro: living multi-device circle + full cliffs.',
    pro: false,
  ...
  harmony: {
    ...
    short: 'Match',
    emoji: '💞',
    tagline: 'Two birthdays · element, animal & path weave.',
    pro: false,
  ...
  pathfinder: {
    ...
    short: 'Path',
    emoji: '🗺',
    tagline: 'Career tracks, money seals, Path & Personality map.',
    pro: false,
    guide: '/guides',
  },
};
