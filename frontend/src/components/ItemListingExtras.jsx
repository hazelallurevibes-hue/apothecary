 ...
 * serviceMode=true hides food-specific fields (wellness services only).
 */
  ...
  if (serviceMode) {
    return (
      <div className={`col-span-full text-xs text-gray-500 mt-2 pt-4 border-t min-w-0 ${className}`}>
        Optional: add session add-ons and video in the sections below. Food safety and allergen fields are not needed for wellness services.
      </div>
    );
  }
