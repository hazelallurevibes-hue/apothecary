    ...
    return (
      <div className="mt-4 mb-2 rounded-2xl border border-[#c9a227]/35 bg-gradient-to-r from-[#4a1942]/8 via-[#f5f0e8] to-[#fff9eb] p-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <Link
            to="/pro-upgrade"
            className="shrink-0 px-4 py-2 bg-[#4a1942] text-white rounded-xl text-sm font-medium hover:bg-[#2d1230]"
          >
  ...
  return (
    <section className="mb-8 rounded-3xl border border-[#c9a227]/30 bg-gradient-to-br from-[#f5f0e8] via-white to-[#4a1942]/5 p-6 sm:p-8">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <Link
          to="/pro-upgrade"
          className="inline-flex items-center justify-center px-8 py-3 bg-[#4a1942] text-white rounded-2xl font-semibold hover:bg-[#2d1230] transition shrink-0"
        >
          {t('pro.hub.featuresHeading')} →
        </Link>
      </div>
