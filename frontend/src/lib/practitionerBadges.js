...
export const ADMIN_AWARD_BADGE_CATALOG = [
  ...
  { id: 'healing_excellence', label: 'Healing Excellence', shortLabel: 'Healing Pro', icon: '🕯', title: 'Awarded for excellence in healing services', className: 'bg-gradient-to-r from-ha-primary/10 to-ha-rose-light text-ha-primary border-ha-primary/25 shadow-sm', tier: BADGE_TIER.ADMIN, priority: 9 },
