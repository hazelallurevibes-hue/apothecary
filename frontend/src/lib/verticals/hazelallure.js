...
export const HAZELALLURE_VERTICAL = {
  ...
  plans: {
    ...
    freeVendorFeatures: [
      ...
      'Maker Studio: claim language helper & photo quality score',
      'Harvest calendar (3 dates) & market packing list',
      'Pickup hours, basic allergen tags, quiet-hour reply',
      'Maker story basics & POS stock counts',
