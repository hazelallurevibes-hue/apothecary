...
export const HAZELALLURE_VERTICAL = {
  ...
  plans: {
    ...
    paidVendorFeatures: [
      ...
      'Email campaigns to people who already bought from you',
      ...
      'Credentials, student honors, and practitioner lounge access',
    ...
    paidCustomerFeatures: [
      ...
      'Pro-only hot remedy monographs & deeper research',
