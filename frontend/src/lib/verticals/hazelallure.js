...
export const HAZELALLURE_VERTICAL = {
  ...
  plans: {
    ...
    paidVendorFeatures: [
      ...
      'Tax pack CSV download for your CPA (orders + quarterly + annual summary)',
      'Abandoned-cart recovery message templates (SMS/email copy)',
      'Market-day mode — one-toggle pickup-only storefront',
      'Review-request QR after pickup handoff',
      'Branded campaign email footer unique to your shop',
      'Multi-staff shift notes for handoffs',
      'Shop story video pin on your public storefront',
      ...
      'Full storefront studio — banners, theme, international shop links',
      'Member discounts that pull Pro shoppers to your shelf',
      'Team seats (up to 50) with permissioned employees',
      'Permit badges, credentials, student honors — trust that converts',
      'Shelf-score coaching, growth hub, and seller analytics',
      'Pro promoted placement signals vs organic-only free listings',
      'Practitioner lounge for peer craft & vendor support threads',
      'Cancel anytime — products stay; Pro tools simply fold back to free',
    ],
    paidCustomerFeatures: [
      'Member discounts from Pro practitioners at checkout',
      'Subscribe & Save on participating products (never run out)',
      'Pro-only hot remedy monographs & densest research deep-dives',
      'Hundreds of free monographs stay free — Pro unlocks hot topics only',
      'Favorites, loyalty points, and faster reorder flows',
      'Pro member pricing on Teaching Sanctum courses',
      'Profile studio — banner, frames, pinned achievements',
      'Start threads in The Hearth + Sanctum lesson progress',
      'Priority support when orders or sessions go sideways',
      'Ratings after fewer purchases than free members',
      'Cancel anytime from Stripe — free shopping remains',
    ],
    advertising: {
