    ...
    <div className="max-w-4xl mx-auto pb-16">
      ...
      <section id="moderation" className="mb-10">
        ...
        <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
          ...
          <p><strong>Community gathering (The Hearth &amp; Practitioner lounge):</strong> Thread starters and repliers must comply with this policy. <strong>Hate speech, slurs, bullying, harassment, and threats are not tolerated.</strong> No medical diagnosis, prescription advice, or emergency triage in public threads. Practitioners must not use gathering spaces to circumvent messaging limits or solicit unverified off-platform payments. Hazel Allure employs automated phrase filters, human moderators, and a strike system; posts may be blocked before publication or flagged for review. Administrators assign moderator profiles; moderators may hide content and issue warnings. Hazel Allure may lock threads, remove posts, or ban accounts without assuming editorial responsibility for user discussions. Certificate and student-honor displays are practitioner-issued; the platform does not verify credentials.</p>
          <p><strong>Prohibited credential claims:</strong> Users may not issue or display platform-generated certificates, badges, transcripts, or wallet entries implying licensure as a physician, nurse, pharmacist, dentist, attorney, licensed therapist, or accredited university graduate. Violations may result in immediate removal. The Sanctum sphere and similar entertainment tools must not be presented as real advice.</p>
          <p><strong>Restricted words:</strong> Administrators maintain a filter list (block, flag, and warn severities). Users attempting to post blocked phrases will receive an error; flagged content may remain visible while queued for moderator review. Add slurs and site-specific prohibited terms via Admin → Compliance → Word filters.</p>
          <p><strong>Practitioner integrity pledge:</strong> Vendors must affirm at signup they will not commit fraud, sell deceptive or dangerous goods, infringe IP, or act with ill intent. Violations may be referred to authorities and business bureaus. Logged acceptances are retained for audit.</p>
