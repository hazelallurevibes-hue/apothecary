    ...
    <div className="max-w-4xl mx-auto pb-24">
      ...
      <section id="vendor" className="mb-12">
        ...
        <div className="space-y-4 text-gray-700 text-sm leading-relaxed">
          ...
          <p><strong>3.6 Launch checklist.</strong> You agree to complete onboarding: (1) verify email, (2) accept safety policies, (3) choose seller path (products only, services, or both), (4) submit photo ID when offering services (product-only sellers may skip ID), (5) post first listing. Hazel Allure may block listing tools until required steps are satisfied. Pending ID review still advances checklist progress.</p>
          <p><strong>3.6a Maker Studio &amp; Pro tools.</strong> Optional Maker Studio and Pro SaaS features (claim helpers, tax pack CSVs, wholesale notes, blend request inboxes, gift wrap settings, client vault notes, market-day mode, etc.) are software conveniences only. They are not legal, tax, medical, or regulatory advice. You remain solely responsible for lawful claims, labeling, permits, taxes, SMS/email consent, restocking subscribed SKUs, and fulfillment promises.</p>
      ...
      <section id="gathering" className="mb-12">
        ...
        <div className="space-y-4 text-gray-700 text-sm leading-relaxed">
          ...
          <p><strong>4b.3 Moderation.</strong> Hazel Allure may remove posts, lock threads, issue warnings, restrict posting, or suspend accounts without notice for policy violations, hate speech, bullying, harassment, spam, or credible safety reports. Automated word filters may block or flag content before publication. Three community strikes within the configured warning window may temporarily restrict posting. Assigned community moderators act on behalf of the platform; their badges indicate role only, not endorsement of their opinions. We have no duty to monitor all posts and no liability for user-generated content.</p>
          <p><strong>4b.3a Zero tolerance.</strong> Hate speech, slurs, bullying, threats, and targeted harassment are prohibited in The Hearth, Practitioner lounge, and cohort rooms. Violations may result in immediate content removal and account action.</p>
