...
console.log('PHASE 6 — Sync price IDs to platform_settings');
console.log('  After products exist, invoke stripe-sync-prices with auto_sync:');
console.log(`    POST ${webhookUrl.replace('stripe-webhook', 'stripe-sync-prices')}`);
console.log('    Body: { "bootstrap": true, "auto_sync": true }');
console.log('  Or Admin → Pro Payments → Sync from Stripe');
console.log('  Then set pro_billing_enabled = true in platform_settings');
console.log('');
