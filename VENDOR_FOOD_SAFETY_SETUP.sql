-- =====================================================
-- Bpicius — Allergens, food safety temps, live streams
-- Run AFTER TIER_SYSTEM_SETUP.sql (safe to re-run)
-- =====================================================

-- Item-level allergen & temperature safety (menu + produce)
...
-- Vendor live stream + archived broadcasts (thumbnails only on public UI)
