...
-- Copy of FARMERS_MARKET_EXTENDED.sql
...
CREATE POLICY "public read vendor_conversations" ON public.vendor_conversations FOR SELECT TO anon, authenticated USING (true);
DROP POLICY IF EXISTS "authenticated insert vendor_conversations" ON public.vendor_conversations;
CREATE POLICY "authenticated insert vendor_conversations" ON public.vendor_conversations FOR INSERT TO anon, authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "authenticated update vendor_conversations" ON public.vendor_conversations;
CREATE POLICY "authenticated update vendor_conversations" ON public.vendor_conversations FOR UPDATE TO anon, authenticated USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "public read vendor_messages" ON public.vendor_messages;
CREATE POLICY "public read vendor_messages" ON public.vendor_messages FOR SELECT TO anon, authenticated USING (true);
DROP POLICY IF EXISTS "authenticated insert vendor_messages" ON public.vendor_messages;
CREATE POLICY "authenticated insert vendor_messages" ON public.vendor_messages FOR INSERT TO anon, authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "authenticated update vendor_messages" ON public.vendor_messages;
CREATE POLICY "authenticated update vendor_messages" ON public.vendor_messages FOR UPDATE TO anon, authenticated USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "public read item_requests" ON public.item_requests;
CREATE POLICY "public read item_requests" ON public.item_requests FOR SELECT TO anon, authenticated USING (true);
DROP POLICY IF EXISTS "authenticated insert item_requests" ON public.item_requests;
CREATE POLICY "authenticated insert item_requests" ON public.item_requests FOR INSERT TO anon, authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "authenticated update item_requests" ON public.item_requests;
CREATE POLICY "authenticated update item_requests" ON public.item_requests FOR UPDATE TO anon, authenticated USING (true) WITH CHECK (true);